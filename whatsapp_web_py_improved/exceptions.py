"""
Excepții pentru biblioteca WhatsApp Web Python îmbunătățită.

Acest modul definește ierarhia de excepții utilizate în bibliotecă pentru o gestionare
mai precisă a erorilor specifice diferitelor componente.
"""
...
class WAAuthenticationError(WABaseError):
    ...
    cu WhatsApp Web, cum ar fi QR code invalid sau expirat.
    """
    pass
...
class WAGroupError(WABaseError):
    """
    Excepție pentru erori legate de grupuri.
    
    Se ridică atunci când apar probleme la operațiunile cu grupuri,
    cum ar fi crearea, modificarea sau gestionarea grupurilor.
    """
    pass
